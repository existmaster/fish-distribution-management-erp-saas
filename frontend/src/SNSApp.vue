            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="orders"
                        to="/orderDeliveryManagements/orders"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="deliveries"
                        to="/orderDeliveryManagements/deliveries"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="products"
                        to="/productInventoryManagements/products"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="inventories"
                        to="/productInventoryManagements/inventories"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="suppliers"
                        to="/transportSupplyManagements/suppliers"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '주문', 
                description: '고객이 수산물을 주문하고 주문 처리 및 배송 관리를 수행하는 주체', 
                key: 'orders', 
                route: '/orderDeliveryManagements/orders',
                ImageUrl: '',
            },
            { 
                title: '배송', 
                description: '주문에 대한 배송 정보를 관리하는 주체', 
                key: 'deliveries', 
                route: '/orderDeliveryManagements/deliveries',
                ImageUrl: '',
            },
            { 
                title: '제품', 
                description: '수산물 제품을 등록하고 관리하는 주체', 
                key: 'products', 
                route: '/productInventoryManagements/products',
                ImageUrl: '',
            },
            { 
                title: '재고', 
                description: '수산물의 입고 및 출고를 관리하고 재고 수량 등을 모니터링하는 주체', 
                key: 'inventories', 
                route: '/productInventoryManagements/inventories',
                ImageUrl: '',
            },
            { 
                title: '공급업체', 
                description: '수산물을 공급하는 회사', 
                key: 'suppliers', 
                route: '/transportSupplyManagements/suppliers',
                ImageUrl: '',
            },

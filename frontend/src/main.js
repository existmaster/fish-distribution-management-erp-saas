...
pluralCaseList.push( {plural: "orderDeliveryManagements/orders", pascal: "OrderDeliveryManagementOrder"} )
pluralCaseList.push( {plural: "orderDeliveryManagements/deliveries", pascal: "OrderDeliveryManagementDelivery"} )

pluralCaseList.push( {plural: "productInventoryManagements/products", pascal: "ProductInventoryManagementProduct"} )
pluralCaseList.push( {plural: "productInventoryManagements/inventories", pascal: "ProductInventoryManagementInventory"} )

pluralCaseList.push( {plural: "transportSupplyManagements/suppliers", pascal: "TransportSupplyManagementSupplier"} )

<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            <String v-if="editMode" label="재고 ID" v-model="value.inventoryId" :editMode="editMode" :inputUI="''"/>
            <String label="제품 ID" v-model="value.productId" :editMode="editMode" :inputUI="''"/>
            <Number label="수량" v-model="value.quantity" :editMode="editMode" :inputUI="''"/>
            <Date label="유통 기한" v-model="value.expiryDate" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
...
<script>
    ...
    export default {
        name: 'ProductInventoryManagementInventory',
        components:{
        },
        props: {

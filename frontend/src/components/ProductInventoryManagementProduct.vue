<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            <String v-if="editMode" label="제품 ID" v-model="value.productId" :editMode="editMode" :inputUI="''"/>
            <String label="제품명" v-model="value.productName" :editMode="editMode" :inputUI="''"/>
            <Money offline label="가격" v-model="value.price" :editMode="editMode" @change="change"/>
            <Number label="재고 수량" v-model="value.stockQuantity" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
...
<script>
    ...
    export default {
        name: 'ProductInventoryManagementProduct',
        components:{
            Money,
        },
        props: {
